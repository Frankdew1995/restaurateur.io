      ...
      cartBtn.forEach(function(btn){
        btn.addEventListener("click", function(event){
          ...
          if (event.target.parentElement.classList.contains("add-item-icon")){
            ...
            const quantity = event.target.parentElement.previousElementSibling.children[1].value;
            ...
            const price = event.target.parentElement.previousElementSibling.previousElementSibling.children[1].textContent;

            console.log(quantity, productName, image);
                          ...
                          <div class="cd-cart__actions">
                            ...
                            <div class="cd-cart__quantity">
                              ...
                              <span class="cd-cart__select">
                                <select class="reset" id="cd-product-${productId}" value="${quantity}" name="quantity">
